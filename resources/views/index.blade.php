        ...
        <div class="container">
          ...
          <form method="POST" action="/" enctype="multipart/form-data">
            ...
            <div class="custom-file">
              <input type="file" class="custom-file-input" id="archive" name="archive">
              <label class="custom-file-label" for="archive">Escolha um arquivo</label>
            </div>
            <p>
          ...
          <div class="row">
            @foreach ($posts as $post)
                ...
                <div class="col-md-4">
                  ...
                  <img class="card-img-top figure-img img-fluid rounded" src="/storage/{{ $post->archive }}">
                    <div class="card-body">
